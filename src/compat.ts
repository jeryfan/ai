/**
 * Temporary compatibility entrypoint preserving the old global API
 ...
 * `getProviders`), per-API lazy wrappers, and image generation.
 *
 * Existing apps switch imports from "@jeryfan/ai" to "@jeryfan/ai/compat" unchanged; new code
 * uses `createModels()` and the provider factories.
 */
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@jeryfan/ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@jeryfan/ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@jeryfan/ai/providers/all" or `Models.getProviders()`. */
