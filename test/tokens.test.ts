...
import { getTestApiKey } from "./env.ts";

// Resolve API tokens at module level (async, runs before tests)
const oauthTokens = await Promise.all([
	getTestApiKey("anthropic"),
	getTestApiKey("github-copilot"),
]);
...
async function testTokensOnAbort<TApi extends Api>(llm: Model<TApi>, options: StreamOptionsWithExtras = {}) {
	...
	// OpenAI providers, zai, and Vercel AI Gateway only send usage in the final chunk,
...
describe("Token Statistics on Abort", () => {
	...
	// =========================================================================
	// OAuth-based providers (credentials from an external auth store)
	// =========================================================================
