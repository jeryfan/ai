...
// object per SDK shape (Mistral, openai APIError, @google/genai ApiError), plus
// the non-Error fallback, truncation, the empty parsed-body edge case, and the
// formatProviderError compose helper.
