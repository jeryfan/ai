...
describe("isContextOverflow", () => {
	...
	it("does not treat throttling 'Too many tokens' as overflow", () => {
		// Some providers return this for HTTP 429 rate limiting, NOT context overflow.
		// Human-readable prefixes from formatProviderError mark these as non-overflow.
	...
	it("does not treat service unavailable as overflow", () => {
